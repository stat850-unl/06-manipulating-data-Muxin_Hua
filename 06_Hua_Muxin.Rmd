...
*If we take a closer look, the line is consists of fluctuations. There are several noteworthy peaks and vallies appears at the first day, around the 50th of the year, the 190th day of the year, the 300th day of the year, the 320th day of the year, around the final 20 days of the year.*  
...
*To compare the births on Fridays (not the 13th) with births on Fridays that are the 13th, I create a new table concacted by table of births on Friday (not the 13th) and table of births on Fridays that are the 13th. Then I lable different cases with catorical class 1 and 2, ultilizing a glimmix process to test if they are different. By looking at the type 3 tests table, the class has a statistically significant effect on the number of births for the p-value of the F test is 0.0008, which is much less than 0.05 (the convention typeI error rate).*
